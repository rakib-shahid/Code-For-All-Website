...
function LatestEvent() {
  ...
  return (
    <section
      id="second-section"
      className="flex pt-20 pb-20 bg-transparent overflow-hidden"
    >
        ...
        <div className="bg-gradient-to-tl from-white to- glow m-4 shadow-xl p-5 rounded-lg w-full max-w-5xl mb-20">
          ...
          <div className="flex justify-between p-10">
            ...
            <p className="text-lg font-mono items-center h-1/2">
              Hello everyone! Are you aiming for a career in Software
              Engineering or looking to dive into the Research Field or just
              looking for internships that could kickstart your journey in the
              tech industry? Don’t miss this unique opportunity to meet Allen
              Kim, a PhD Meta Research Scientist, on April 17th.
            </p>
          </div>
        </div>
      </div>
