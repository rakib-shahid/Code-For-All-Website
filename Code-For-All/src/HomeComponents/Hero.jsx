    ...
    <div className="relative flex items-center">
      ...
      >
        ...
        <p className="text-2xl md:text-xl mb-8 mt-5 text-center font-mono">
          ...
          <span className="text-green-500">Programmers,</span>{" "}
        ...
        <p className="text-lg md:text-xl mb-8 text-center font-mono opacity-100 ">
          ...
          <span className="text-purple-500 textglow">
            The mission of Code for All is to empower students of all
            backgrounds to excel in their problem-solving and coding classes. We
        ...
        <button
          onClick={handleClick}
          className="bg-purple-500 p-3 px-8 border border-purple-500 rounded-full text-xl hover:scale-105 ease-in-out duration-300 text-white font-semibold font-mono hover:glow"
        >
          Get Started
        </button>
      </section>
